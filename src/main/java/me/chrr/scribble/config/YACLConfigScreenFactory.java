                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .binding(Config.DEFAULT.openVanillaBookScreenOnShift, () -> config.openVanillaBookScreenOnShift,
                                                (value) -> config.openVanillaBookScreenOnShift = value)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        .build())
